...
describe("revenueRouter", () => {
  ...
  it("listReceipts: distributed=false filtresi dağıtılmamışları döner", async () => {
    ...
    await db
      ...
      .where((await import("drizzle-orm")).eq(receipts.shelbyReceiptHash, "0xh1"))
