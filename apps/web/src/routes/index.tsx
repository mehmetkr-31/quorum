      ...
      <section className="relative overflow-hidden py-24 sm:py-32">
        ...
        <div className="max-w-5xl mx-auto px-6 text-center">
          ...
          <p className="text-neutral-400 text-lg sm:text-xl mb-12 max-w-2xl mx-auto leading-relaxed">
            Quorum is a decentralized DAO where domain experts collaboratively build, curate, and
            govern high-quality AI training datasets.
          </p>
        </div>
      </section>
        ...
        <div className="flex items-end justify-between mb-12">
          <div>
            ...
            <p className="text-neutral-400">
              High-quality, community-verified data ready for training.
            </p>
          </div>
        </div>
        ...
        {isLoading ? (
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {[...Array(3)].map((_, i) => (
              <div
                key={i}
                className="h-48 rounded-2xl bg-neutral-900 animate-pulse border border-neutral-800"
              />
            ))}
          </div>
        ) : (
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  ...
                  <span className="text-xs font-mono text-neutral-500">
                    w: {ds.totalWeight.toLocaleString()}
                  </span>
                </div>
                ...
                <div className="flex items-center justify-between text-xs">
                  <span className="px-2 py-1 rounded-md bg-neutral-800 text-neutral-400 uppercase tracking-wider font-semibold">
                    Active
                  </span>
